...
3. **Import Logs**: Without logging in on another character (which would overwrite the logs), go to the NPCs tab in StoneEye and click "Upload Logs"
   - C:\Users\myuser\AppData\LocalLow\Elder Game\Project Gorgon\ for logs and C:\Users\myuser\AppData\LocalLow\Elder Game\Project Gorgon\reports\ for the json exports.
